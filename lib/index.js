...
program.command('create')
    ...
    .action(({ description, contentUri }) => __awaiter(void 0, void 0, void 0, function* () {
    const streamId = yield stream.createStream(description, contentUri);
...
program.command('update')
    ...
    .action((streamId, { description, contentUri }) => __awaiter(void 0, void 0, void 0, function* () {
    yield stream.updateStream(streamId, description, contentUri);
}));
