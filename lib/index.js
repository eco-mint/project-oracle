...
program.command('identity')
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, identity.createIdentity()];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
program.command('create')
    ...
    .action(function (filePath) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, stream.createStream(filePath)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
...
program.command('view')
    ...
    .action(function (streamId, _a) {
    var commitId = _a.commitId, latest = _a.latest;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, stream.viewStream(streamId, commitId, latest)];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
...
program.command('update')
    ...
    .action(function (streamId, _a) {
    var description = _a.description, uri = _a.uri;
    return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, stream.updateStream(streamId, description, uri)];
                case 1:
                    _b.sent();
                    return [2 /*return*/];
            }
